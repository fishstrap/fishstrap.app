...
<div
    class="font-['Inter_Variable'] flex bg-black w-full min-h-screen flex-col text-white transition-all">
    <div
        ...
        <p class="mt-4 text-xl text-white/75">
            Search the community database to find a mod you like. From themes,
            to sound effects, and even bootstrapper themes.
        </p>
    </div>

    <main class="mx-16 flex flex-col xl:flex-row w-fit mt-24 items-start gap-8">
        <div class="w-full xl:w-80 shrink-0 flex flex-col gap-6 z-100">
            <div
        ...
        <div class="flex flex-wrap flex-1 gap-4 w-fit">
