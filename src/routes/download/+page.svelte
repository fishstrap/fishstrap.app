...
<div in:fly={{ y: -50, duration: 600 }} class="flex overflow-hidden flex-col">
    <div
        class="justify-center items-center flex h-screen w-screen pointer-events-none flex-col z-100">
        <div
            class="text-transparent bg-clip-text text-center bg-gradient-to-r from-astronaut-blue-300 to-astronaut-blue-600 z-100">
